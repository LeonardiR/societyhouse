( function( window, $, undefined ) {
	...
	$( function() {
		 ...
		 *
		 * Gets the heights of the window, the adminbar, the tools, the header,
		...
		function on() {
			...
			/*
		 	 * Adjust when collapsing the header, changing the columns
		 	 * or changing the body class.
			 */
			$document.on( 'wp-collapse-header.editor-expand postboxes-columnchange.editor-expand editor-classchange.editor-expand', adjust )
