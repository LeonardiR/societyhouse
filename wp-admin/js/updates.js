...
(function( $, wp, settings ) {
	...
	wp.updates.refreshCount = function() {
		...
		// Update the "Updates" header item.
		...
		// Update the "Plugins" header item.
		...
		// Update the "Appearance" header item.
	 ...
	 *
	 * This includes the toolbar, the "Updates" header item and the header items
