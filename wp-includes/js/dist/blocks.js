...
/**
 * Common regexes.
 * We declare some components regexes to improve performance
 */
...
/**
 * Returns the block's default header item classname from its name.
 *
 * @param {string} blockName The block name.
 *
 * @return {string} The block's default header item class.
 */
