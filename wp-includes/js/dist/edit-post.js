...
// CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/plugins/copy-content-header-item/index.js
...
function CopyContentMenuItem(_ref) {
  ...
  return Object(external_this_wp_element_["createElement"])(external_this_wp_components_["ClipboardButton"], {
    ...
    className: "components-header-item__button",
...
// CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/plugins/keyboard-shortcuts-help-header-item/index.js
...
// CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/header/tools-more-header-group/index.js
...
// CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/header/plugins-more-header-group/index.js
...
// CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/header/options-header-item/index.js
...
// CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/header/writing-header/index.js
...
// CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/header/more-header/index.js
...
var more_menu_MoreMenu = function MoreMenu() {
  return Object(external_this_wp_element_["createElement"])(external_this_wp_components_["Dropdown"], {
    className: "edit-post-more-header",
...
// CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/block-settings-header/plugin-block-settings-header-group.js
...
var globalShortcuts = {
  ...
  shortcuts: [{
    ...
    description: Object(external_this_wp_i18n_["__"])('Open the block navigation header.')
  }, {
    keyCombination: ctrl('`'),
...
function (_Component) {
  ...
  Object(createClass["a" /* default */])(FullscreenMode, [{
    ...
    value: function componentDidMount() {
      ...
      // `sticky-header` to be applied by WordPress and prevents the admin header being scrolled
      // even if `is-fullscreen-mode` is then removed. Let's remove `sticky-header` here as
...
// CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/block-settings-header/plugin-block-settings-header-item.js
...
/**
 * Plugins may want to add an item to the header either for every block
...
// CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/header/plugin-more-header-item/index.js
...
// CONCATENATED MODULE: ./node_modules/@wordpress/edit-post/build-module/components/header/plugin-sidebar-more-header-item/index.js
